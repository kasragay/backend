...
const (
	packageCaller = "internal/server/gateway"
)
...
<html lang="en">
  <head>
    ...
    <link rel="icon" type="image/png" href="{{.FaviconURL32}}" sizes="32x32" />
    <link rel="icon" type="image/png" href="{{.FaviconURL16}}" sizes="16x16" />
    {{- if .CustomStyle}}
      <style>
        body { margin: 0; }
        {{.CustomStyle}}
